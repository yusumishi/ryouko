ABOUT RYOUKO:
Ryouko is a simple Web browser coded in Python/PyQt4. It is a fork of the C++/Qt4-based Web browser, Haruna2 (http://foxhead128.deviantart.com/art/Haruna2-245283932), and a distant cousin of the Haruna2 fork XWebSurfer.

AUTHORS:
For authors, see AUTHORS.txt.

LICENSING TERMS:
For licensing terms, see LICENSE.html.
